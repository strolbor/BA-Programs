...
def plotter(df, suffix):
    ...
    for solver in solvers:
        ...
        plt.scatter(solver_df['Year-DIMACS'], solver_df['dimacs-analyzer-time'], label=solver, color=color_map[solver])
        plt.plot(solver_df['Year-DIMACS'], solver_df['dimacs-analyzer-time'], marker='o', color=color_map[solver])
